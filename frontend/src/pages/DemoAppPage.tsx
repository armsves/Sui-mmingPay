    ...
    <Grid columns="2" gap="4">
      <Card>
        <Flex direction="column" gap="2" align="center" style={{ height: '100%' }}>
          ...
          <Link to="/demo-app/allowlist-example">
      ...
      <Card>
        <Flex direction="column" gap="2" align="center" style={{ height: '100%' }}>
          ...
          <Link to="/demo-app/subscription-example">
            <Button size="3">Try it</Button>
          </Link>
        </Flex>
      </Card>
  ...
  return (
    <>
      <Container>
        ...
        {!currentAccount && <p>Please connect your wallet to continue</p>}
      </Container>
      {currentAccount && (
        <Routes>
          <Route path="/demo-app" element={<DemoLandingPage />} />
          {/* Allowlist Example Routes */}
          <Route path="/demo-app/allowlist-example" element={<CreateAllowlist />} />
          <Route path="/demo-app/allowlist-example/admin/allowlist/:id" element={
            <div>
          ...
          <Route path="/demo-app/allowlist-example/admin/allowlists" element={<AllAllowlist />} />
          <Route path="/demo-app/allowlist-example/view/allowlist/:id" element={<Feeds suiAddress={currentAccount?.address || ''} />} />
          {/* Subscription Example Routes */}
          <Route path="/demo-app/subscription-example" element={<CreateService />} />
          <Route path="/demo-app/subscription-example/admin/service/:id" element={
            <div>
          ...
          <Route path="/demo-app/subscription-example/admin/services" element={<AllServices />} />
          <Route path="/demo-app/subscription-example/view/service/:id" element={<FeedsToSubscribe suiAddress={currentAccount?.address || ''} />} />
        </Routes>
      )}
    </>
  );
